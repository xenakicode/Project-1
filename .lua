...
repeat
 ...
 -- Menu/UI Creation
 if not isfile("obscura.win") then
 ...
 KeybindGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(0, 0, 0)), ColorSequenceKeypoint.new(0.50, Color3.fromRGB(155, 181, 210)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(0, 0, 0))}
 ...
 Name.Text = "[<font color=\"rgb(155, 181, 210)\">Keybinds</font>]"
 ...
 Name_2.Text = "Silent Aim: <font color=\"rgb(155, 181, 210)\">[MB1]</font>"
 ...
 local function createWatermark()
    ...
    WatermarkFrame.BorderColor3 = Color3.fromRGB(155, 181, 210)
    ...
    task.spawn(function()
       while task.wait() do
         ...
         WaterMarkLabel.Text = 'obscura.win.<font color="rgb(155, 181, 210)">prod</font> - uid: <font color="rgb(155, 181, 210)">' .. uid .. '</font> / fps: <font color="rgb(155, 181, 210)">' .. fpsValue .. '</font> / ping: <font color="rgb(255, 5, 9)">' .. ping .. '</font> / time: <font color="rgb(255, 5, 9)">' .. time .. '</font>'
       end
    end)
    return Watermark
 end
 ...
 local library = {
    Title = 'obscura.<font color="rgb(155, 181, 210)">corporation</font>',
    keybind = Enum.KeyCode.RightBracket,
    Watermark = createWatermark(),
       Colors = {
          libColor = Color3.fromRGB(155, 181, 210),
          riskyColor = Color3.fromRGB(255, 0, 0),
          FontColor = Color3.fromRGB(255, 255, 255),
          MainColor = Color3.fromRGB(14, 14, 14),
          AccentColor = Color3.fromRGB(155, 181, 210),
    ...
    CloneScreenGui.Name = "obscura.win_gui"
    ...
    for _, obj in pairs(menu:GetDescendants()) do
        if obj.Name:lower():find('name_esp') then
           obj.Text = '<font color="rgb(155, 181, 210)">' .. game.Players.LocalPlayer.Name .. '</font>'
        end
    end
            ...
            draggable(menu.bg)
                ...
                function library:Tween(...) TweenService:Create(...):Play() end
                    function library:addTab(name,image)
                        ...
                        local imageTweenStart = TweenService:Create(v, tweenInfo, {ImageColor3 = Color3.fromRGB(155, 181, 210)})
                        local textTweenStart = TweenService:Create(v.text, tweenInfo, {TextColor3 = Color3.fromRGB(155, 181, 210)})
                        ...
                        function group:addToggle(args)
                            ...
                            function toggle:addKeybind(args)
                                    ...
                                    if key.Name == "Unknown" or key.Name == "Unknown" then
                                        ...
                                        if args.gui then
                                            ...
                                            if args.type == "hold" then
                                                Name.Text = "<font color=\"rgb(255,255,255)\">" ..args.text.. ":</font>".." <font color=\"rgb(155, 181, 210)\">" .."["..keyName.."]".. "</font> ("..args.type..")"
                                            else
                                                if not Toggle then
                                                    Toggle = true
                                                    Name.Text = "<font color=\"rgb(255,255,255)\">" ..args.text.. ":</font>".." <font color=\"rgb(155, 181, 210)\">" .."["..keyName.."]".. "</font> ("..args.type..")"
                                                    ...
                                                    Toggle = false
                                                    Name.Text = "<font color=\"rgb(125, 125, 125)\">" ..args.text.. ": /font>".." <font color=\"rgb(155, 181, 210)\">" .."["..keyName.."]".. "</font> ("..args.type..")"
                                                end
                                            end
                                        end
                                    end
                                ...
                                if args.gui then
                                    Name.Visible = true
                                    Name.Text = args.text..": <font color=\"rgb(155, 181, 210)\">" .."["..keyName.."]".. "</font> ("..args.type..")"
                                end
                        ...
                        for _, v in pairs(list) do
                            ...
                            writefile("obscura.win/"..name..".cfg",game:GetService("HttpService"):JSONEncode(jig))
                ...
                function library:refreshConfigs()
                    local tbl = {}
                    for i,v in next, listfiles("obscura.win") do table.insert(tbl,v) end
